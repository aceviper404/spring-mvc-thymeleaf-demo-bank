...
public interface UserRepository extends CrudRepository<User, Integer>{
	...
	@Modifying
	@Query(value = "INSERT INTO users (first_name, last_name, email, password, token, code, created_at, updated_at) VALUES"
			+ "(:first_name, :last_name, :email, :password, :token, :code, NOW(), NOW())", nativeQuery = true)
	@Transactional
